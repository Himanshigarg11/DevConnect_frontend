...
import SilverPremiumPage from "./SilverPremiumPage";
import GoldPremiumPage from "./GoldPremiumPage";
...
const Premium = () => {
  ...
  const plans = [
    {
      ...
      button: "Start Silver",
      icon: <Zap size={32} />,
      features: ["Unlimited Chat with Connections", "Basic Profile Boost"],
    },
    {
      name: "Dev Gold",
      price: "₹299",
  ...
  return isUserPremium ? (
     membershipType === "Dev Gold" ? (
      <GoldPremiumPage />
   ) : membershipType === "Dev Silver" ? (
      <SilverPremiumPage />
   ) : null
  ) : (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-gray-900 text-white py-16 px-6">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto">
          Get better visibility, premium matching, and powerful features to grow
          your developer network faster.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto">
        {plans.map((plan, index) => (
          ...
          >
            ...
            {/* Plan Name */}
            <h2 className="text-4xl font-bold mb-3">{plan.name}</h2>
